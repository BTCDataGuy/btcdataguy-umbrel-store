# BTCDataGuy Umbrel Community App Store

> **Umbrel Community App Store** featuring Bitcoin mining and node management applications by BTCDataGuy

## 📦 How to Add This App Store

1. Open your Umbrel dashboard
2. Go to **App Store** settings
3. Add this repository URL: `https://github.com/BTCDataGuy/btcdataguy-umbrel-store`
4. Browse and install apps from the BTCDataGuy store
...
1. Add this Community App Store to your Umbrel (see instructions above)
2. Install Node Miner from the BTCDataGuy store
3. Open the app from your Umbrel dashboard
4. Configure your pool settings
5. Start mining!
...
- Available in the official Umbrel App Store
...
- GitHub Issues: https://github.com/BTCDataGuy/btcdataguy-umbrel-store/issues
